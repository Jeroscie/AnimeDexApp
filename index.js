...
app.get('/api/upcoming/:pageNumber', async (req, res) => {
    try {
        ...
        const apiUrl = `https://testaopi.vercel.app/api/upcoming/${pageNumber}`;
...
app.get('/api/popular/:pageNumber', async (req, res) => {
    try {
        const pageNumber = req.params.pageNumber;
        const apiUrl = `https://testaopi.vercel.app/api/popular/${pageNumber}`;
        const response = await fetch(apiUrl);
        const data = await response.json();
        res.json(data);
    } catch (error) {
...
app.get('/api/recent/:pageNumber', async (req, res) => {
    try {
        const pageNumber = req.params.pageNumber;
        const apiUrl = `https://testaopi.vercel.app/api/recent/${pageNumber}`;
        const response = await fetch(apiUrl);
        const data = await response.json();
        res.json(data);
    } catch (error) {
...
app.get('/api/anime/:animeName', async (req, res) => {
    try {
        ...
        const apiUrl = `https://testaopi.vercel.app/api/anime/${animeName}`;
        const response = await fetch(apiUrl);
        const data = await response.json();
        res.json(data);
    } catch (error) {
...
app.get('/api/episode/:animeName/:episodeNumber', async (req, res) => {
    try {
        ...
        const apiUrl = `https://testaopi.vercel.app/api/episode/${animeName}/${episodeNumber}`;
        const response = await fetch(apiUrl);
        const data = await response.json();
...
app.get('/api/search', async (req, res) => {
    try {
        ...
        const apiUrl = `https://testaopi.vercel.app/api/search?query=${encodeURIComponent(query)}`;
        const response = await fetch(apiUrl);
        const data = await response.json();
        res.json(data);
    } catch (error) {
